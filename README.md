...
### Quota Exceeded
As of 16th June 2023, I have reached my request quota. You must either use your own proxy or use darkhub's proxy. You are now able to select darkhub's proxy as an option while using the patcher.

If you wish to view the source code of their proxy, you can view it [here](https://github.com/Stefanuk12/RoProPatcher/tree/go-lang).
...
Somehow, the subscription has been expired for a while but still works. Perhaps constantly keeping the token alive meant that I have unlimited subscription.
